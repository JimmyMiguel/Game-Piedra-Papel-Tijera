var T=Object.defineProperty;var E=(e,t,o)=>t in e?T(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o;var h=(e,t,o)=>E(e,typeof t!="symbol"?t+"":t,o);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function o(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=o(r);fetch(r.href,n)}})();class R extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
  <style>
    * {
...
`)}}customElements.define("btn-com",R);class j extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){if(!this.shadowRoot)return;this.shadowRoot.innerHTML=`
    ...
    <piedra-com></piedra-com>
    `;const c=this.randomFun();console.log(c),this.mostrarJugadaComputadora(c),clearTimeout(this.timeoutId);const s=(d=this.shadowRoot)==null?void 0:d.querySelector(".circle");s==null||s.classList.add("hidden"),l.setState("piedra",c),setTimeout(()=>{u("/ganador")},2e3)});const r=(w=this.shadowRoot)==null?void 0:w.querySelector(".btn-papel");if(!((v=this.shadowRoot)!=null&&v.querySelector(".hands")))return;const n=(S=this.shadowRoot)==null?void 0:S.querySelector(".hands");r==null||r.addEventListener("click",()=>{var d;console.log("muy bien aplastate un papel"),n.classList.add("clicked"),n.innerHTML="",n.innerHTML=`
        <papel-com></papel-com>
        `;const c=this.randomFun();this.mostrarJugadaComputadora(c),clearTimeout(this.timeoutId);const s=(d=this.shadowRoot)==null?void 0:d.querySelector(".circle");s==null||s.classList.add("hidden"),l.setState("papel",c),setTimeout(()=>{u("/ganador")},2e3)});const i=(L=this.shadowRoot)==null?void 0:L.querySelector(".btn-tijera");if(!this.shadowRoot.querySelector(".hands"))return;const p=this.shadowRoot.querySelector(".hands");i==null||i.addEventListener("click",()=>{var d;console.log("muy bien aplastate un tijera"),p.classList.add("clicked"),p.innerHTML="",p.innerHTML=`
        <tijera-com></tijera-com>
        `;const c=this.randomFun();this.mostrarJugadaComputadora(c),clearTimeout(this.timeoutId);const s=(d=this.shadowRoot)==null?void 0:d.querySelector(".circle");s==null||s.classList.add("hidden"),l.setState("tijera",c),setTimeout(()=>{u("/ganador")},2e3)})}randomFun(){const o=["piedra","papel","tijera"];function a(n){const i=Math.floor(Math.random()*n.length);return n[i]}return a(o)}mostrarJugadaComputadora(o){var n;const a=(n=this.shadowRoot)==null?void 0:n.querySelector(".randomHand");if(!a)return;a.innerHTML="";let r="";o==="piedra"?r="<piedra-com></piedra-com>":o==="papel"?r="<papel-com></papel-com>":o==="tijera"&&(r="<tijera-com></tijera-com>"),a.innerHTML=r}temporizadorCom(o){var r,n,i;clearTimeout(this.timeoutId);const a=(r=this.shadowRoot)==null?void 0:r.querySelector(".countdown");if(o>=0)a.textContent=`${o}`,this.timeoutId=setTimeout(()=>{this.temporizadorCom(o-1)},1e3);else{const p=(n=this.shadowRoot)==null?void 0:n.querySelector(".container");if(p){p.innerHTML=`
      ...
      `;const m=(i=this.shadowRoot)==null?void 0:i.querySelector("#reiniciarJuego");m==null||m.addEventListener("click",()=>{this.render(),this.gameLogic(),this.temporizadorCom(5)})}}}}customElements.define("game-com",k);const f="/Game-Piedra-Papel-Tijera",z=[{path:new RegExp(`^${f}/?$`),action:()=>document.createElement("welcome-page")},{path:new RegExp(`^${f}/readycom/?$`),action:()=>document.createElement("ready-com")},{path:new RegExp(`^${f}/gameCom/?$`),action:()=>document.createElement("game-com")},{path:new RegExp(`^${f}/ganador/?$`),action:()=>document.createElement("game-over-screen")}];let g=null;function b(e){if(!g){console.error("Container not initialized!");return}for(const t of z)if(t.path.test(e)){g.innerHTML="";const o=t.action();g.appendChild(o);return}console.log("No route matched, showing 404"),g.innerHTML="<h2>404 - Página no encontrada</h2>"}function u(e){history.pushState({},"",e),b(e)}function H(e){g=e,window.addEventListener("popstate",()=>{b(location.pathname)}),b(location.pathname)}class M extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
        ...
        `)}}customElements.define("piedra-com",A);const q="/Game-Piedra-Papel-Tijera/assets/fondo-azul-BDkdt0nR.jpg";class G extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){if(!this.shadowRoot)return;this.shadowRoot.innerHTML=`
      <style>
        * {
          box-sizing: border-box;
          margin:0;
    ...
    `;const t=this.shadowRoot.querySelector("#startBtn");t==null||t.addEventListener("click",()=>{u("/readycom")})}}customElements.define("welcome-page",G);(function(){const t=document.getElementById("app");t&&H(t)})();
