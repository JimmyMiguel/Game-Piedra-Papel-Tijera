var L=Object.defineProperty;var B=(e,t,o)=>t in e?L(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o;var u=(e,t,o)=>B(e,typeof t!="symbol"?t+"":t,o);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function o(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(r){if(r.ep)return;r.ep=!0;const i=o(r);fetch(r.href,i)}})();class v extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
  <style>
    * {
...
`)}}customElements.define("btn-com",v);const w="/Game-Piedra-Papel-Tijera/assets/fondo-azul-BDkdt0nR.jpg";class R extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){if(!this.shadowRoot)return;this.shadowRoot.innerHTML=`
    ...
    `;const t=this.shadowRoot.querySelector("#startBtn");t==null||t.addEventListener("click",()=>{g("/gameCom")})}}customElements.define("ready-com",R);const h={listener:[],resultado:"",partidasGanadas:{userComputer:0,userJugador:0},winGame(e,t){return e===t?"Empate":e==="piedra"&&t==="tijera"||e==="papel"&&t==="piedra"||e==="tijera"&&t==="papel"?(this.partidasGanadas.userJugador++,"Ganaste"):(this.partidasGanadas.userComputer++,"Perdiste")},getState(){return this.partidasGanadas},setState(e,t){const o=this.winGame(e,t);this.resultado=o;for(const a of this.listener)a();this.saveToLocalStorage()},saveToLocalStorage(){try{const e=JSON.stringify(this.partidasGanadas);localStorage.setItem("game-scores",e)}catch(e){console.error("Error al guardar en localStorage:",e)}},loadFromLocalStorage(){try{const e=localStorage.getItem("game-scores");if(e){const t=JSON.parse(e);t&&typeof t.userJugador=="number"&&typeof t.userComputer=="number"&&(this.partidasGanadas=t)}}catch(e){console.error("Error al cargar desde localStorage:",e)}}};h.loadFromLocalStorage();const O="/Game-Piedra-Papel-Tijera/assets/win-6UgLvupI.jpg";class Q extends HTMLElement{constructor(){super();u(this,"resultText","");u(this,"playerScore",0);u(this,"machineScore",0);u(this,"buttonText","Volver a Jugar");this.attachShadow({mode:"open"})}connectedCallback(){this.loadAttributes(),this.render(),this.attachEventListeners(),this.aplicarEstilos()}loadAttributes(){const o=h.getState(),a=h.resultado;this.resultText=a||this.resultText,this.playerScore=o.userJugador,this.machineScore=o.userComputer,this.buttonText=this.getAttribute("button-text")||this.buttonText}render(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
        <style>
          :host {
            display: block;
            height: 100%;
      ...
      `)}attachEventListeners(){var a;const o=(a=this.shadowRoot)==null?void 0:a.getElementById("playAgainButton");o==null||o.addEventListener("click",()=>{g("/gameCom")})}aplicarEstilos(){var a;if(h.resultado==="Ganaste"){const r=(a=this.shadowRoot)==null?void 0:a.querySelector(".star-container");r==null||r.classList.add("win")}}}customElements.define("game-over-screen",Q);class j extends HTMLElement{constructor(){super();u(this,"timeoutId");this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.gameLogic(),this.temporizadorCom(5)}render(){this.shadowRoot&&(this.shadowRoot.innerHTML=`
      <style>
        * {
          box-sizing: border-box;
        }
    ...
    `)}gameLogic(){var p,A,x,E,y,S,C;const o=(p=this.shadowRoot)==null?void 0:p.querySelector(".btn-piedra");if(!((A=this.shadowRoot)!=null&&A.querySelector(".hands")))return;const a=(x=this.shadowRoot)==null?void 0:x.querySelector(".hands");o==null||o.addEventListener("click",()=>{var d;a.classList.add("clicked"),a.innerHTML="",a.innerHTML=`
    <piedra-com></piedra-com>
    `;const c=this.randomFun();console.log(c),this.mostrarJugadaComputadora(c),clearTimeout(this.timeoutId);const s=(d=this.shadowRoot)==null?void 0:d.querySelector(".circle");s==null||s.classList.add("hidden"),h.setState("piedra",c),setTimeout(()=>{g("/ganador")},2e3)});const r=(E=this.shadowRoot)==null?void 0:E.querySelector(".btn-papel");if(!((y=this.shadowRoot)!=null&&y.querySelector(".hands")))return;const i=(S=this.shadowRoot)==null?void 0:S.querySelector(".hands");r==null||r.addEventListener("click",()=>{var d;console.log("muy bien aplastate un papel"),i.classList.add("clicked"),i.innerHTML="",i.innerHTML=`
        <papel-com></papel-com>
        `;const c=this.randomFun();this.mostrarJugadaComputadora(c),clearTimeout(this.timeoutId);const s=(d=this.shadowRoot)==null?void 0:d.querySelector(".circle");s==null||s.classList.add("hidden"),h.setState("papel",c),setTimeout(()=>{g("/ganador")},2e3)});const n=(C=this.shadowRoot)==null?void 0:C.querySelector(".btn-tijera");if(!this.shadowRoot.querySelector(".hands"))return;const m=this.shadowRoot.querySelector(".hands");n==null||n.addEventListener("click",()=>{var d;console.log("muy bien aplastate un tijera"),m.classList.add("clicked"),m.innerHTML="",m.innerHTML=`
        <tijera-com></tijera-com>
        `;const c=this.randomFun();this.mostrarJugadaComputadora(c),clearTimeout(this.timeoutId);const s=(d=this.shadowRoot)==null?void 0:d.querySelector(".circle");s==null||s.classList.add("hidden"),h.setState("tijera",c),setTimeout(()=>{g("/ganador")},2e3)})}randomFun(){const o=["piedra","papel","tijera"];function a(i){const n=Math.floor(Math.random()*i.length);return i[n]}return a(o)}mostrarJugadaComputadora(o){var i;const a=(i=this.shadowRoot)==null?void 0:i.querySelector(".randomHand");if(!a)return;a.innerHTML="";let r="";o==="piedra"?r="<piedra-com></piedra-com>":o==="papel"?r="<papel-com></papel-com>":o==="tijera"&&(r="<tijera-com></tijera-com>"),a.innerHTML=r}temporizadorCom(o){var r,i,n;clearTimeout(this.timeoutId);const a=(r=this.shadowRoot)==null?void 0:r.querySelector(".countdown");if(o>=0)a.textContent=`${o}`,this.timeoutId=setTimeout(()=>{this.temporizadorCom(o-1)},1e3);else{const m=(i=this.shadowRoot)==null?void 0:i.querySelector(".container");if(m){m.innerHTML=`
    ...
    `;const t=this.shadowRoot.querySelector("#startBtn");t==null||t.addEventListener("click",()=>{g("/readycom")})}}customElements.define("welcome-page",Y);(function(){const t=document.getElementById("app");t&&U(t)})();
